...
const CAMERA_POSITION_KEYS: Vector3Keyframe[] = [
  ...
  { at: 0.3, value: [0.0, 1.7, 8.2] }, // HOLDS through the launch
...
const CAMERA_TARGET_KEYS: Vector3Keyframe[] = [
  ...
  { at: 0.3, value: [0.0, 0.75, 0.0] }, // holds — the ship rises up-left within the frame
...
const CAMERA_FOV_KEYS: ScalarKeyframe[] = [
  ...
  { at: 0.3, value: FOV_START }, // hold through the launch…
...
const SHIP_POSITION_KEYS: Vector3Keyframe[] = [
  ...
  { at: 0.12, value: [0.0, 0.75, 0.0] }, // 40% up, 0% left
  { at: 0.21, value: [-1.0, 1.25, 0.0] }, // 70% up, 20% left
  { at: 0.3, value: [-1.5, 1.65, 0.0] }, // 100% up, 30% left
  { at: 0.55, value: [-8.0, 1.35, -1.0] }, // flying left across
  { at: 0.75, value: [-12.5, 0.9, -2.0] }, // nearing the meteor
